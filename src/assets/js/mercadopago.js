!(function (e) {
  ...
  function (e, t, n) {
    ...
    (function (e) {
      ...
      i(v, "_publicKey", void 0),
        i(v, "_locale", void 0),
        i(v, "_deviceProfile", void 0);
    }.call(this, "/"));
  },
  function (e, t, n) {
    (function (t) {
    ...
    e.exports = function (e) {
      return (
        (o(u, e) && (s || "string" == typeof u[e])) ||
          (s && o(l, e) ? (u[e] = l[e]) : (u[e] = d("Symbol." + e))),
        u[e]
      );
    };
  },
  ...
  function (e, t, n) {
    ...
    if ((!P || !k || k === E) && ((k = x.prototype), P))
      for (r in _) a[r] && h(a[r].prototype, k);
    if ((P && p(w) !== k && h(w, k), o && !c(k, A)))
      for (r in ((C = !0),
      f(k, A, {
        get: function () {
      ...
      (h = function (e) {
        ...
        if (
          (x &&
            ...
            (A = String(e).slice(d.lastIndex)),
            d.lastIndex > 0 &&
              (!d.multiline || (d.multiline && "\n" !== e[d.lastIndex - 1])) &&
              ((E = "(?: " + E + ")"), (A = " " + A), M++),
            (n = new RegExp("^(?:" + E + ")", k))),
          g && (n = new RegExp("^" + E + "$(?!\\s)", k)),
          m && (r = d.lastIndex),
          (i = f.call(x ? n : d, A)),
          x
            ? i
              ...
              : (d.lastIndex = 0)
            : m && i && (d.lastIndex = d.global ? i.index + i[0].length : r),
          g &&
            i &&
            i.length > 1 &&
          ...
          for (i.groups = s = c(null), a = 0; a < w.length; a++)
            s[(l = w[a])[0]] = i[l[1]];
        return i;
      }),
      (e.exports = h);
      ...
      if (
        (_ &&
          ...
          h !== Object.prototype &&
            ...
            (d ||
              o(w) === h ||
              (a ? a(w, h) : "function" != typeof w[v] && c(w, v, g)),
            s(w, M, !0, !0),
            d && (f[M] = g))),
        "values" == p &&
          P &&
  ...
  function (e, t, n) {
      ...
      U = function (e) {
        ...
        for (n = [], r = 0; r < t; r++) {
          ...
          if (
            ...
            i.length > 1 &&
              "0" == i.charAt(0) &&
              ((o = _.test(i) ? 16 : 8), (i = i.slice(8 == o ? 1 : 2))),
            "" === i)
          )
            a = 0;
          else {
              ...
              if (a && (P.test(a) || "+" == a || "-" == a || "." == a))
                ...
                (h = ""),
                  "file" == e.scheme
                    ...
                    : "/" == o[f + 1]
                    ? ((l = ie), f++)
                    : ((e.cannotBeABaseURL = !0), e.path.push(""), (l = ye));
              }
              break;
            case ne:
    ...
    if (
      ...
      Ne &&
        u(ke, "createObjectURL", function (e) {
          return Ne.apply(b, arguments);
        }),
        Ue &&
          u(ke, "revokeObjectURL", function (e) {
  ...
  function (e, t, n) {
    ...
    var r = n(18),
      ...
      G = function (e, t, n) {
        return !(V(e, (t = m(t, !0))) && y(n) && v(n, "value")) ||
          v(n, "get") ||
          v(n, "set") ||
          n.configurable ||
      ...
      ? (N ||
        ...
        (e.exports = function (e, t, n) {
          ...
          N
            ...
            U && d(g, U, s),
            (A[s] = v),
            r({ global: !0, forced: v != m, sham: !N }, A),
            "BYTES_PER_ELEMENT" in v || d(v, "BYTES_PER_ELEMENT", o),
            "BYTES_PER_ELEMENT" in g || d(g, "BYTES_PER_ELEMENT", o),
            M(s);
        }))
      : (e.exports = function () {});
  },
  ...
  function (e, t, n) {
    ...
    var r = n(1),
      ...
      F = function (e, t, n, r, i, o) {
        ...
        for (
          var c = x(s.buffer).bytes, u = a + s.byteOffset, l = r(+i), d = 0;
          d < t;
          d++
        )
          c[u + d] = l[o ? d : t - d - 1];
      ...
      (M = function (e) {
        ...
        s(A.prototype, {
          ...
          getUint32: function (e) {
            return (
              R(U(this, 4, e, arguments.length > 1 ? arguments[1] : void 0)) >>>
              0
            );
          },
    ...
    b(M, "ArrayBuffer"),
      b(A, "DataView"),
      (e.exports = { ArrayBuffer: M, DataView: A });
  },
  function (e, t) {
    var n = Math.abs,
      r = Math.pow,
      ...
      pack: function (e, t, s) {
        ...
        for (
          (e = n(e)) != e || e === 1 / 0
            ...
            : ((c = i(o(e) / a)),
              e * (l = r(2, -c)) < 1 && (c--, (l *= 2)),
              (e += c + h >= 1 ? m / l : m * r(2, 1 - h)) * l >= 2 &&
                (c++, (l /= 2)),
              c + h >= p
                ? ((u = 0), (c = p))
                : c + h >= 1
                ? ((u = (e * l - 1) * r(2, t)), (c += h))
                : ((u = e * r(2, h - 1) * r(2, t)), (c = 0)));
          t >= 8;
          d[g++] = 255 & u, u /= 256, t -= 8
        );
        for (
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      var t,
        ...
        g = o(p);
      if (null != g && !a(g))
        for (f = (d = g.call(p)).next, p = []; !(l = f.call(d)).done; )
          p.push(l.value);
      for (
        v && h > 2 && (m = s(m, arguments[2], 2)),
          n = i(p.length),
          u = new (c(this))(n),
          t = 0;
        n > t;
  ...
  function (e, t) {
    var n = Math.floor,
      ...
      o = function (e, t, n) {
        for (
          var r = e.length, i = t.length, o = 0, a = 0, s = [];
          o < r || a < i;

        )
          o < r && a < i
            ? s.push(n(e[o], t[a]) <= 0 ? e[o++] : t[a++])
            : s.push(o < r ? e[o++] : t[a++]);
        return s;
      };
    e.exports = r;
  ...
  function (e, t, n) {
    ...
    e.exports =
      ...
      i(function () {
        ...
        ? function (e, t) {
            for (
              var n = c(e), i = arguments.length, l = 1, d = a.f, f = s.f;
              i > l;
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      ...
      if (
        ...
        for (n = new m((t = s(h.length))); t > w; w++)
          (p = y ? g(h[w], w) : h[w]), c(n, w, p);
      else
        for (f = (d = b.call(h)).next, n = new m(); !(l = f.call(d)).done; w++)
          (p = y ? o(d, g, [l.value, w], !0) : l.value), c(n, w, p);
      return (n.length = w), n;
    };
  },
  function (e, t, n) {
  ...
  function (e, t, n) {
    ...
    e.exports = function (e) {
      ...
      for (t = 0; t < a.length; t++)
        (n = a[t]), o.push(r.test(n) ? "xn--" + l(n) : n);
      return o.join(".");
    };
  },
  function (e, t, n) {
          ...
          if (v(u))
            if ("function" == typeof (e = w(u)))
              for (n = (t = e.call(u)).next; !(r = n.call(t)).done; ) {
                if (
                  (a = (o = (i = b(m(r.value))).next).call(i)).done ||
                  (s = o.call(i)).done ||
                  !o.call(i).done
                )
            ...
            else for (c in u) f(u, c) && p.push({ key: c, value: u[c] + "" });
          else
            N(
              p,
              "string" == typeof u
  ...
  function (e, t, n) {
    ...
    const i = {
      ...
      f = ({ required: e }) => ({
        type: "string",
        validateFn: (e) =>
          /^[a-zA-ZãÃáÁàÀâÂäÄẽẼéÉèÈêÊëËĩĨíÍìÌîÎïÏõÕóÓòÒôÔöÖũŨúÚùÙûÛüÜçÇ’ñÑ .']*$/.test(
            e
          ),
        required: e,
      }),
          ...
          return {
            ...
            identificationType: h({
              required:
                null == n
                  ? void 0
                  : n.includes("cardholder_identification_type"),
            }),
            identificationNumber: m({
              required:
                null == n
                  ? void 0
                  : n.includes("cardholder_identification_number"),
            }),
            securityCode: v({
      ...
      w = ({ methodName: e, incomingParams: t, validateFieldsParams: n }) => {
        const r = new A(),
          o = ((e, t, n) => b[e](t, n))(e, j.getContext("cardSettings"), n);
        return (
          o ||
            r.addError({
              ...i.default,
          ...
          t && "object" == typeof t
            ? (Object.entries(o).forEach(([e, n]) => {
                var o, a;
                const { type: s, required: c, validateFn: u } = n,
                  l = t[e],
                  d =
                    (null === (o = i[e]) || void 0 === o
                      ? void 0
                      : o.invalid) || i.default,
                  f =
                    (null === (a = i[e]) || void 0 === a ? void 0 : a.empty) ||
                    i.default;
      ...
      k = (e = navigator.userAgent || navigator.vendor || window.opera) =>
    ...
    var T = () =>
      new Promise((e, t) => {
        ...
        (s.src = "https://http2.mlstatic.com/storage/event-metrics-sdk/js"),
          (s.type = "text/javascript"),
          (s.async = !0),
          s.setAttribute("data-client-info-name", "MercadoPago-SDK-Javascript"),
          s.setAttribute("data-client-info-version", r.h),
          ...
          s.setAttribute(
            ...
            (function () {
              ...
              for (let e = 0; e < t.length; e++)
                n += (e < 2 || e > 5 ? "" : "-") + t[e].toString(16).slice(-4);
              return n;
            })()
          ),
    ...
    n(68), n(126);
    const { protocol: P, hostname: C, port: _ } = window.location,
      S = `${P}//${C}${_ && ":" + _}`,
      O = ({ URLObject: e, restClientOptions: t }) => (
        ((e) => {
          e.searchParams.append("public_key", r.i.getPublicKey()),
            e.searchParams.append("locale", r.i.getLocale()),
            e.searchParams.append("js_version", r.h),
            e.searchParams.append("referer", S);
        })(e),
        (({ URLObject: e, restClientOptions: t }) => {
          const n = null == t ? void 0 : t.query;
          n &&
            (Object.entries(n).forEach(([t, n]) => e.searchParams.append(t, n)),
            null == t || delete t.query);
        })({ URLObject: e, restClientOptions: t }),
        e
      ),
      I = ({ fetchURL: e, restClientOptions: t }) => {
        const { timeout: n } = t;
        let r;
        const i = new Promise((n, i) => {
            ...
            new Promise(function (e, t) {
              ...
              for (var u in (n.open(a.method || "get", o, !0),
              (n.onload = function () {
                n
          ...
          o = new Promise(
            (e, t) =>
              (r = setTimeout(() => t(new Error("Request timed out")), n))
          );
    ...
    class L {
      static async fetch(e, t) {
        const n =
          ((i = t),
          Object.assign({ method: "GET", timeout: 1e3, retry: 2 }, i));
        var i;
        return (async ({ fetchURL: e, restClientOptions: t }) => {
          ...
          do {
            n--;
            try {
              const n = await I({ fetchURL: e, restClientOptions: t }),
                r = n.status;
              return r < 200 || r > 299
                ? Promise.reject(await n.json())
                : Promise.resolve(n);
            } catch (e) {
    ...
    var N = class {
      ...
      getInstallments(e) {
        return (async (e) => {
          const t = await L.fetch("/payment_methods/installments", {
            method: "GET",
            query: { ...e },
          });
          return await t.json();
      ...
      getPaymentMethods(e) {
        return (async (e) => {
          const t = await L.fetch("/payment_methods/search", {
            method: "GET",
            query: { marketplace: "NONE", status: "active", ...e },
          });
          return await t.json();
        })(e);
      }
      getIssuers(e) {
        return (async (e) => {
          const t = await L.fetch("/payment_methods/card_issuers", {
            method: "GET",
            query: e,
          });
          return await t.json();
      ...
      createCardToken(e) {
        return (async (e) => {
          const t = await L.fetch("/card_tokens", {
            method: "POST",
            headers: { "X-Product-Id": k() ? r.g : r.f },
    ...
    const F = {
      ...
      B = (e, t) => {
        const n = z.find(({ name: t }) => ("id" === t ? "form" : t) === e),
      ...
      V = (e) => {
        ...
        return e.map((e) => {
          var n;
          const r =
            null == t || null === (n = t.get(e)) || void 0 === n
              ? void 0
              : n.element;
      ...
      Y = (e, t) => {
        var n;
        const r = j.getContext("formMap"),
          i =
            null == r || null === (n = r.get(e)) || void 0 === n
              ? void 0
              : n.element;
        ...
        form: [
          ...
          },
          {
            ...
            fn: async (e) => {
              const t = (() => {
                var e;
                const t = j.getContext("cardFormOptions"),
                ...
                return (
                  ...
                  o.setAttribute("name", "MPHiddenInputAmount"),
                  o.setAttribute("value", r),
                  null === (e = i.element) || void 0 === e || e.appendChild(o),
                  () => o.remove()
                );
              })();
              try {
              ...
              const n = j.getContext("customCallbacks"),
              ...
              ((e, t) => {
                ...
                if (r < 6 && i) {
                  ...
                  return (
                    ...
                    H(a),
                    G(a, s),
                    e.delete("additional_info_needed"),
                    e.delete("security_code"),
                    void e.delete("card_number")
                  );
                }
                if (r >= 6 && !i) {
                  const e = j
    ...
    class X {
      constructor() {
        J(this, "formMap", void 0),
          J(this, "cardFormModules", void 0),
          J(this, "cardSettings", void 0),
          (this.formMap = j.getContext("formMap")),
          (this.cardFormModules = j.getContext("cardFormModules")),
          (this.cardSettings = j.getContext("cardSettings"));
      }
      onFormMounted({ error: e, customCallback: t }) {
        ...
        this.formMap.get("identificationType") && (null == n || n()),
          null == t || t();
      }
      onIdentificationTypesReceived({ error: e, data: t, customCallback: n }) {
        ...
        const i =
            null === (r = this.formMap.get("identificationType")) ||
            void 0 === r
              ? void 0
              : r.element,
      ...
      onPaymentMethodsReceived({ error: e, data: t, customCallback: n }) {
        ...
        if (null == t || !t.length)
          return null == n
            ? void 0
            : n(new Error("MercadoPago.js - No payment methods found"));
        const r = null == t ? void 0 : t[0].payment_type_id;
        if (!D.includes(r))
          return null == n
            ? void 0
            : n(new Error(`Payment Method ${r} not supported.`));
        ...
        this.cardSettings.set("payment_type_id", d),
          this.cardSettings.set("additional_info_needed", s),
          this.cardSettings.set("security_code", p),
          this.cardSettings.set("card_number", f);
        const h = String(null == c ? void 0 : c.id);
        Y("paymentMethods", a),
          l && Y("merchantAccountId", l),
          s.includes("issuer_id")
            ? null == o || o()
            : (() => {
                var e;
                const t =
                  null === (e = this.formMap.get("issuer")) || void 0 === e
                    ? void 0
                    : e.element;
      ...
      onInstallmentsReceived({ error: e, data: t, customCallback: n }) {
        ...
        if (e) return null == n ? void 0 : n(e);
        const o =
            null === (r = this.formMap.get("installments")) || void 0 === r
              ? void 0
              : r.element,
          a = document.createDocumentFragment();
        null == t ||
          null === (i = t.payer_costs) ||
          void 0 === i ||
          i.forEach((e) => {
            const t = document.createElement("option");
      ...
      onIssuersReceived({ error: e, data: t, customCallback: n }) {
        ...
        if (e) return null == n ? void 0 : n(e);
        const i =
            null === (r = this.formMap.get("issuer")) || void 0 === r
              ? void 0
              : r.element,
          o = document.createDocumentFragment();
        null == t ||
    ...
    class Oe {
      constructor(e, t) {
        if (
          (re.set(this, { writable: !0, value: void 0 }),
          ie.set(this, { writable: !0, value: void 0 }),
          oe.set(this, { writable: !0, value: void 0 }),
          ae.set(this, { writable: !0, value: void 0 }),
          ...
          fe.set(this, {
            ...
            value: async () => {
              ...
              const i =
                null === (e = Q(this, ae)) || void 0 === e
                  ? void 0
                  : e.onIdentificationTypesReceived;
              try {
                var o, a, s;
                r =
                  null === (o = Q(this, ae)) ||
                  ...
                  void 0 === a
                    ? void 0
                    : a.call(o, "identificationTypes");
                const e = await (null === (s = Q(this, ie)) || void 0 === s
                  ? void 0
                  : s.getIdentificationTypes());
                return (
                  (n =
                    e &&
                    ((e) =>
                      e.map(({ id: e, name: t }) => ({ id: e, name: t })))(e)),
                  Promise.resolve(n)
                );
              } catch (e) {
                (t = e),
                ...
                var c, u;
                Q(this, Se).call(this, r) &&
                  (null === (c = r) || void 0 === c || c()),
                  null === (u = Q(this, ce)) ||
                    void 0 === u ||
                    u.onIdentificationTypesReceived({
                      error: t,
                      customCallback: i,
                      data: n,
                    });
            ...
            value: async () => {
              ...
              try {
                ...
                r =
                  ...
                  void 0 === a
                    ? void 0
                    : a.call(o, "paymentMethods");
                const [e, l] = V(["cardNumber", "processingMode"]),
                  d = await (null === (s = Q(this, ie)) || void 0 === s
                    ? void 0
                    : s.getPaymentMethods({ bin: E(e), processingMode: l }));
                return (
                  (n =
                    d &&
                    d.results.map(
              ...
              try {
                ...
                r =
                  ...
                  void 0 === a
                    ? void 0
                    : a.call(o, "issuers");
                const [e, l] = V(["paymentMethods", "cardNumber"]),
                  d = await (null === (s = Q(this, ie)) || void 0 === s
                    ? void 0
                    : s.getIssuers({ paymentMethodId: e, bin: E(l) }));
                return (
                  (n =
                    d &&
                    d.map(
            ...
            value: async () => {
              ...
              try {
                ...
                r =
                  ...
                  void 0 === a
                    ? void 0
                    : a.call(o, "installments");
                const e = j.getContext("cardSettings"),
                  [d, f] = V(["cardNumber", "processingMode"]),
                  p = await (null === (s = Q(this, ie)) || void 0 === s
                    ? void 0
                    : s.getInstallments({
                        amount:
                          null === (c = Q(this, se)) || void 0 === c
                            ? void 0
                            : c.get("amount"),
                        bin: E(d),
                        processingMode: f,
                ...
                return (
                  (n = ((e) => {
                    const { payer_costs: t, merchant_account_id: n = "" } =
                      e[0];
                    return {
          ...
          ve.set(this, {
            ...
            value: () => {
              ...
              null === (e = Q(this, oe)) ||
                void 0 === e ||
                e.forEach(({ hidden: e }, t) => {
                  Q(this, ge).call(this, t),
                    e ||
                      (Q(this, xe).call(this, t),
                      Q(this, ye).call(this, t),
                      Q(this, be).call(this, t));
                });
            },
          }),
          ge.set(this, {
            ...
            value: (e) => {
              ...
              const r =
                  null === (t = Q(this, oe)) || void 0 === t
                    ...
                    : t.get(e),
                i = {
                  listeners: (({ optionName: e }) => Z[e])({ optionName: e }),
                  ...r,
                };
              null === (n = Q(this, oe)) || void 0 === n || n.set(e, i);
            },
          ...
          be.set(this, {
            ...
            value: (e) => {
              var t;
              const { element: n, listeners: r } =
                null === (t = Q(this, oe)) || void 0 === t ? void 0 : t.get(e);
              if (null != r && r.length)
                try {
                  r.forEach((e) => {
                    null == e ||
                      e.event.forEach((t) => {
                        null == n ||
                          n.addEventListener(t, null == e ? void 0 : e.fn);
                      });
                  });
                } catch (e) {
                  throw new Error(
                    "MercadoPago.js - Something went wrong adding EventListeners: " +
                      e.message
                  );
                }
            },
          ...
          we.set(this, {
            ...
            value: () => {
              ...
              null === (e = Q(this, oe)) ||
                void 0 === e ||
                e.forEach(({ element: e, listeners: t }) => {
                  e &&
                    t &&
                    t.forEach((t) => {
          ...
          xe.set(this, {
            ...
            value: (e) => {
              var t;
              const { placeholder: n, element: r } =
                null === (t = Q(this, oe)) || void 0 === t ? void 0 : t.get(e);
              n &&
                ("SELECT" === (null == r ? void 0 : r.tagName)
                  ? G(r, n)
                  : (r.placeholder = n));
            },
          }),
          ...
          Ee.set(this, {
            ...
            value: () => {
              ee(this, ue, () => {
                this.mount(),
                  document.removeEventListener("DOMContentLoaded", Q(this, ue));
              }),
                "loading" === document.readyState
                  ? document.addEventListener("DOMContentLoaded", Q(this, ue))
                  : this.mount();
            },
          }),
          Me.set(this, {
          ...
          Te.set(this, {
            writable: !0,
            value: () => {
              j.createContext("cardSettings"),
                j.createContext("customCallbacks", Q(this, ae)),
                j.createContext("cardFormModules", {
          ...
          Ce.set(this, {
            ...
            value: () => {
              ...
              Object.values(F).forEach((e) => {
                ...
                var r;
                (t.setAttribute("id", "MPHiddenInput" + $(e)),
                t.setAttribute("name", "MPHiddenInput" + $(e)),
                t.setAttribute("type", "hidden"),
                "processingMode" === e) &&
                  t.setAttribute(
                    "value",
                    null === (r = Q(this, se)) || void 0 === r
                      ? void 0
                      : r.get("processingMode")
                  );
                n.appendChild(t);
              });
              const r =
        ...
        ee(
          this,
          se,
          j.createContext("cardFormOptions", { amount: a, processingMode: c })
        ),
          ee(
            this,
            oe,
            j.createContext(
              ...
              (({ id: e, ...t }) => {
                ...
                return {
                  ...
                  merchantAccountId: { id: "MPHiddenInput" + $(o), hidden: !0 },
                  ...t,
                };
              })(o)
            )
          ...
          ee(this, ae, u),
          ee(this, ie, new U({ services: new N() })),
          Q(this, Me).call(this),
          s && Q(this, Ee).call(this),
          (ne = this);
      }
      mount() {
        ...
        try {
          ...
          var t, n;
          const r =
            null === (t = Q(this, ae)) || void 0 === t
              ? void 0
              : t.onFormMounted;
          null === (n = Q(this, ce)) ||
            void 0 === n ||
            n.onFormMounted({ error: e, customCallback: r }),
            document.removeEventListener("DOMContentLoaded", Q(this, ue));
        }
      }
      unmount() {
      ...
      submit() {
        ...
        try {
          var e;
          const t =
            null === (e = Q(this, oe)) || void 0 === e ? void 0 : e.get("form");
      ...
      async createCardToken() {
        ...
        try {
          ...
          const [e, l, d, f, p, h, m] = V([
            ...
            v = await (null === (s = Q(this, ie)) || void 0 === s
              ? void 0
              : s.createCardToken(
                  {
                    cardNumber: E(e),
          ...
          Q(this, Se).call(this, r) &&
            ...
            null === (u = Q(this, ce)) ||
              void 0 === u ||
              u.onCardTokenReceived({ error: t, customCallback: i, data: n });
        }
      }
      getCardFormData() {
        let e;
    ...
    class Le {
      constructor({
        ...
        Ie(this, "id", void 0),
          Ie(this, "src", void 0),
          Ie(this, "hidden", void 0),
          Ie(this, "closeButton", void 0),
          Ie(this, "styles", void 0),
          Ie(this, "bodyOverflow", void 0),
          Ie(this, "showLoader", void 0),
          Ie(this, "spinner", void 0),
          Ie(this, "wrapper", void 0),
          ...
          r && ((this.el = this.create()), this.render());
      }
      createWrapper() {
    ...
    class Ne {
      constructor(e) {
        Re(this, "options", void 0),
          Re(this, "el", void 0),
          Re(this, "styles", void 0),
          (this.options = e),
          (this.el = this.create()),
    ...
    var He = {
      getCheckoutParams: (e = {}) => Be(e, { ...We, ...$e }),
      getTokenizerParams: (e = {}) => (
        (e.tokenizer.publicKey = r.i.getPublicKey()), Be(e, { ...We, ...ze })
      ),
    };
    const Ve = {
    ...
    var Ye = {
      getFullUrl: async (e, t) => {
        const n = r.i.getPublicKey(),
          i = (
            await new N().getPaymentMethods({ limit: 1, public_key: n })
    ...
    class gt {
      constructor(e) {
        Qe.set(this, { writable: !0, value: void 0 }),
          ...
          ct.set(this, { writable: !0, value: void 0 }),
            ...
            value: (e) => {
              ...
              return (
                Ze(this, rt)
                  ...
                  : (t = He.getCheckoutParams(e)),
                Ye.getFullUrl(Ze(this, ot), t)
              );
            },
          }),
          ft.set(this, {
          ...
          mt.set(this, {
            writable: !0,
            value: (e) => {
              Je(this, nt, document.createElement("form")),
                (Ze(this, nt).action = Ze(this, it)),
                (Ze(this, nt).method = "POST"),
                (Ze(this, nt).style.visibility = "hidden"),
                e.value.forEach((e) => {
                  const t = document.createElement("input");
                  (t.name = e.id),
                    (t.value = e.value),
                    Ze(this, nt).appendChild(t);
                }),
                document.body.appendChild(Ze(this, nt)),
                Ze(this, nt).submit();
            },
          }),
          vt.set(this, {
          ...
          Ke(this, "render", (e) => {
            ...
            Je(this, et, document.querySelector(e.container)),
              e.label && (t = e.label),
              e.type && (n = e.type),
              Je(this, tt, new Ne({ label: t, type: n })),
              Ze(this, vt).call(this),
              Ze(this, tt).render(Ze(this, et));
          }),
          Ke(this, "open", () => {
            Ze(this, lt)
              ? console.warn("There is already a checkout instance open")
              : (Je(
                  this,
                  Qe,
                  new Le({
                ...
                "redirect" !== Ze(this, ot)
                  ? (Je(this, lt, !0),
                    Ze(this, ht).call(this),
                    Ze(this, Qe).render())
                  : Ze(this, st) && (window.location.href = Ze(this, st)));
          }),
          Je(this, rt, !!e.tokenizer),
          Je(this, it, null),
          Je(this, ot, k() ? "redirect" : "modal"),
          Je(this, at, !!e.autoOpen),
          Je(this, ct, "mercadopago-checkout"),
          Je(this, ut, !1),
          Je(this, lt, !1),
          e.render &&
            !Ze(this, at) &&
    ...
    const yt = ["public_key", "email", "totalAmount", "action", "cancelURL"],
      bt = /^(https?):\/\/[^\s$.?#].[^\s]*$/;
    let wt;
    !(function (e) {
      (e.email = "email"),
    ...
    var At = new WeakMap();
    class Tt {
      constructor(e = { type: "", email: "", action: "", totalAmount: "" }) {
        var t;
        At.set(this, { writable: !0, value: void 0 }),
          e.cancelURL ||
            (e.cancelURL =
              (null === (t = window.top) || void 0 === t
                ? void 0
                : t.location.href) || window.location.href);
        const n = kt(e);
        if (n.length) throw n;
        Et(this, At, e);
      }
        ...
        St.set(this, { writable: !0, value: void 0 }),
          ...
          Rt.set(this, {
            ...
            value: (e) => {
              const t = ((e) => {
                ...
                return "string" !== t
                  ? new Error(
                      "MercadoPago.js - Type of public_key must be string. Received " +
                        t
                    )
                  : /\s/g.test(e)
                  ? new Error(
          ...
          jt.set(this, {
            ...
            value: (e) => {
              const t = ((e) => {
                const t = new A(),
                  { locale: n, advancedFraudPrevention: o } = e;
                return (
                  n &&
                    ("string" != typeof n &&
                      t.addError({
                        ...i.default,
                        description:
                          "Type of locale must be string. Received " + typeof n,
                      }),
                    Object.keys(r.e).includes(n) ||
                      t.addError({
                        ...i.default,
          ...
          qt.set(this, {
            writable: !0,
            value: (e) =>
              Object.assign({ locale: x(), advancedFraudPrevention: !0 }, e),
          }),
          Nt.set(this, {
            writable: !0,
            value: async () => {
              Pt(this, Lt, new N()),
                Pt(this, It, new U({ services: Ct(this, Lt) })),
                await Ct(this, Ut).call(this);
            },
          }),
          Ut.set(this, {
            writable: !0,
            value: async () => {
              try {
                ...
                return (
                  console.warn("SRE Metrics could not be loaded", e),
                  Promise.resolve()
                );
              }
            },
          ...
          Ft.set(this, {
            ...
            value: async () => {
              try {
                ...
                const t = await (async () => {
                  try {
                    const e = await L.fetch("/devices/widgets", {
                        method: "POST",
                        body: JSON.stringify({
                ...
                return (
                  console.warn("DeviceProfile could not be loaded", e),
                  Promise.resolve()
                );
              }
            },
          }),
          Ct(this, Rt).call(this, e),
          Ct(this, jt).call(this, t),
          Pt(this, St, Ct(this, qt).call(this, t)),
          r.i.setPublicKey(e),
          r.i.setLocale(Ct(this, St).locale),
          Pt(this, Ot, Ct(this, Nt).call(this)),
          Ct(this, Ft).call(this);
      }
      async getIdentificationTypes() {
